...
$x_{\text{step}} = x + \delta \nabla_x J(\theta, x,  y)$.
To see this in action, we apply it to the first image from the dataset:

\begin{figure}
\centering
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{duck.png}
    \caption{Original image}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[width=\textwidth]{duck-convertible.png}
    \caption{Image after attack}
\end{subfigure}
\end{figure}
